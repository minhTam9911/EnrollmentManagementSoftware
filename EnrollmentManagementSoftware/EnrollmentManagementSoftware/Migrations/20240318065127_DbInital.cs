        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: true),
                    WagePercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Subsidize = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SubsidizeName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Salaries_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradingMethodId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GradeTypes_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GradeTypes_GradingMethods_GradingMethodId",
                        column: x => x.GradingMethodId,
                        principalTable: "GradingMethods",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Subjects_MajorSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Day_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeTypes_AcademicYearId",
                table: "GradeTypes",
                column: "AcademicYearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_MinorSubjectId",
                table: "Teachers",
